...
function transformFrontendToDb(frontendData: Record<string, unknown>): Partial<DbStartupData> {
  return {
    mint: frontendData.mint as string,
    creator_wallet: frontendData.creatorWallet as string,
    name: frontendData.name as string,
    symbol: frontendData.symbol as string,
    description: frontendData.description as string | undefined,
    image_url: frontendData.imageUrl as string | undefined,
    category: frontendData.category as string | undefined,
    problem_statement: frontendData.problemStatement as string | undefined,
    solution_overview: frontendData.solutionOverview as string | undefined,
    value_proposition: frontendData.valueProposition as string | undefined,
    total_addressable_market: frontendData.totalAddressableMarket as string | undefined,
    target_market: frontendData.targetMarket as string | undefined,
    competition_analysis: frontendData.competitionAnalysis as string | undefined,
    team_size: frontendData.teamSize as number | undefined,
    founders: frontendData.founders as string | undefined,
    founder_linkedin: frontendData.founderLinkedIn as string | undefined,
    current_traction: frontendData.currentTraction as string | undefined,
    stage: frontendData.stage as string | undefined,
    funding_goal: frontendData.fundingGoal as number | undefined,
    minimum_investment: frontendData.minimumInvestment as number | undefined,
    use_of_funds: frontendData.useOfFunds as string | undefined,
    previous_funding: frontendData.previousFunding as string | undefined,
    website: frontendData.website as string | undefined,
    twitter: frontendData.twitter as string | undefined,
    discord: frontendData.discord as string | undefined,
    pitch_deck_url: frontendData.pitchDeckUrl as string | undefined,
    github_url: frontendData.githubUrl as string | undefined,
    whitepaper_url: frontendData.whitepaperUrl as string | undefined,
    demo_url: frontendData.demoUrl as string | undefined,
    video_pitch_url: frontendData.videoPitchUrl as string | undefined,
    short_term_goals: frontendData.shortTermGoals as string | undefined,
    long_term_vision: frontendData.longTermVision as string | undefined,
    company_name: frontendData.companyName as string | undefined,
    registration_country: frontendData.registrationCountry as string | undefined,
    registration_number: frontendData.registrationNumber as string | undefined,
  };
}
