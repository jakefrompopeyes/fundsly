...
function deriveBondingCurvePda(mint, programId) {
  const [pda] = PublicKey.findProgramAddressSync(
...
function deriveSolVaultPda(mint, programId) {
  const [pda] = PublicKey.findProgramAddressSync(
...
function deriveMigrationVaultPda(mint, programId) {
  const [pda] = PublicKey.findProgramAddressSync(
...
function deriveMigrationAuthorityPda(programId) {
  const [pda] = PublicKey.findProgramAddressSync(
